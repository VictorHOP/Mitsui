    ...
    <table>
        <tr style="width:100%; border: 1px solid gray; border-radius:5px; box-shadow: 0px 6px 30px rgba(0, 0, 0, 0.15);padding-bottom:30px">
            ...
            <td>
                ...
                <a class="repeatable-add button" style="margin-bottom: 20px;" href="#">Adicionar novo banner</a>
            </td>
        </tr>
        ...
        <tr style="width:100%; border: 1px solid gray; border-radius:5px; box-shadow: 0px 6px 30px rgba(0, 0, 0, 0.15); padding-bottom:30px">
            ...
            <td>
                <a class="repeatable-add button" style="margin-top: 20px;" href="#">Adicionar novo slide</a>
                <ul class="custom_repeatable">
                    <?php
                    $i = 0;
                    if ($produtos_home) {
                    ...
                    ?>
                            <li>
                                ...
                                <input type="text" name="produtos_home[<?php echo $i; ?>][1]" placeholder="Ex: Vagões, Locomotiva" value="<?php echo $row[1]; ?>" /><br>
                        ...
                        <li>
                            ...
                            <label for="">Nome do Serviço: </label>
                            <input type="text" name="produtos_home[<?php echo $i; ?>][1]" placeholder="Ex: Vagões, Locomotiva" /><br>
                ...
                <a class="repeatable-add button" href="#">Adicionar novo slide</a>
            </td>
        </tr>
    </table>
<?php
